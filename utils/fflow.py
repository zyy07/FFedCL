...
def read_option():
    ...
    parser.add_argument('--con_lr', help='fedsercon7 sgd learning rate', type=float, default=0.1)
    parser.add_argument('--con_n', help='fedsercon7 sgd iteration num', type=int, default=2)
    parser.add_argument('--con_topnum', help='fedsercon7 topnum', type=int, default=1000)
    parser.add_argument('--con_th', help='fedsercon7 threshold', type=float, default=0.01)
